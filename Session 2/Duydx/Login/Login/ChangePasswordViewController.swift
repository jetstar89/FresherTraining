...
class ChangePasswordViewController: UIViewController {
    ...
    func initView() {
        ...
        setBorderTextField(passWordOldTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))
        setBorderTextField(passWordNewTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))
        setBorderTextField(passWordAgainNewTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))
        showIconNewPassword()
...
extension ChangePasswordViewController: UITextFieldDelegate {
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        if textField == passWordOldTextField {
            ...
            setBorderTextField(passWordOldTextField, UIColor.init(red: 239/255, green: 137/255, blue: 15/255, alpha: 1.0))
        } else if textField == passWordNewTextField {
            passWordNewTextField.textColor = UIColor(red: 63/255, green: 95/255, blue: 163/255, alpha: 1.0)
            setBorderTextField(passWordNewTextField, UIColor.init(red: 239/255, green: 137/255, blue: 15/255, alpha: 1.0))
        } else if textField == passWordAgainNewTextField {
            passWordAgainNewTextField.textColor = UIColor(red: 63/255, green: 95/255, blue: 163/255, alpha: 1.0)
            setBorderTextField(passWordAgainNewTextField, UIColor.init(red: 239/255, green: 137/255, blue: 15/255, alpha: 1.0))
        }
        return true
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        if textField == passWordOldTextField {
            passWordOldTextField.textColor = UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1)
            setBorderTextField(passWordOldTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))
        } else if textField == passWordNewTextField {
            passWordNewTextField.textColor = UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1)
            setBorderTextField(passWordNewTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))
            if passWordNewTextField.text == "" {
                showNewPasswordButton.isHidden = true
            }
        } else if textField == passWordAgainNewTextField {
            passWordAgainNewTextField.textColor = UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1)
            setBorderTextField(passWordAgainNewTextField, UIColor(red: 182/255 , green: 190/255, blue: 197/255, alpha: 1))

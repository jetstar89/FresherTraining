...
extension PersonViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let idenfier = "cell"
        let cell: PersonTableViewCell = personTableView.dequeueReusableCell(withIdentifier: idenfier, for: indexPath) as! PersonTableViewCell
        cell.avatarImageView.image = listPerson[indexPath.row].avatar
        cell.idLabel.text = listPerson[indexPath.row].id

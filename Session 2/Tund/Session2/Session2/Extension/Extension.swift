...
extension UIView {
    func setIsOnSelect(_ isOnSelect: Bool) {
        self.backgroundColor = isOnSelect ? UIColor.darkGray : UIColor.init(
            red: 63/255, green: 95/255, blue: 163/255, alpha: 1.0)
        let border = CALayer()
        let width = CGFloat(4.0)
        border.borderColor = isOnSelect ? UIColor.white.cgColor : UIColor.init(
            red: 63/255, green: 95/255, blue: 163/255, alpha: 1.0).cgColor
